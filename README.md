...
Что сделано :
 ...
 - Устанвлен Terraform
 - написан файл main.tf с описанием  провайдера и процесса создания истанса на основе базовго образа, а также добавления правила firewall
 - создан файл outputs.tf c описанием выходых переменных (IP адреса созданного на основе описания инстанса)
 ...
 - в variables.tf соотвествующая параметру count переменная
